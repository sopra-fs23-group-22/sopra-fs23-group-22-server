...
public class Piece {
    ...
    public AttackResult attack(Square sourceSquare, Square targetSquare) {
        return this.pieceType.getAttackStrategy().attack(sourceSquare, targetSquare);
    }

    public MoveResult move(Square sourceSquare, Square targetSquare) {
        return this.pieceType.getMoveStrategy().move(sourceSquare, targetSquare);
    }
